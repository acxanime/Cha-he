...
APP_ID = int(os.environ.get("APP_ID", "28918271")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "29bf447b916a795191046a91317869fb") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002468801481")) #Your db channel Id
OWNER = os.environ.get("OWNER", "sewxiy") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7475464684")) # Owner id
#--------------------------------------------
...
OWNER_TAG = os.environ.get("OWNER_TAG", "sitaratoons_support")
UPI_ID = os.environ.get("UPI_ID", "sitaratoons@axl")
QR_PIC = os.environ.get("QR_PIC", "https://acxanimess.github.io/Pay/")
SCREENSHOT_URL = os.environ.get("SCREENSHOT_URL", f"t.me/sitaratoons_support")
#--------------------------------------------
#Time and its price
#7 Days
...
#3 Month
PRICE3 = os.environ.get("PRICE3", "230 rs")
#6 Month
PRICE4 = os.environ.get("PRICE4", "350 rs")
#1 Year
PRICE5 = os.environ.get("PRICE5", "600 rs")
