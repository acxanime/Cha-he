...
FORCE_PIC = os.environ.get("FORCE_PIC", "https://graph.org/file/408dd0a6b3fdf6b2d3f7c-91eb9f67a912bdaf09.jpg")
#--------------------------------------------
...
#--------------------------------------------
#--------------------------------------------
START_MSG = os.environ.get("START_MESSAGE", "<b>Hᴇʟʟᴏ 💕 {mention} \n\n ɪ Aᴍ Fɪʟᴇ Sᴛᴏʀᴇ Bᴏᴛ, ɪ Cᴀɴ Sᴛᴏʀᴇ Pʀɪᴠᴀᴛᴇ Fɪʟᴇs Iɴ Sᴘᴇᴄɪғɪᴇᴅ Cʜᴀɴɴᴇʟ Aɴᴅ Oᴛʜᴇʀ Usᴇʀs Cᴀɴ Aᴄᴄᴇss Iᴛ Fʀᴏᴍ Sᴘᴇᴄɪᴀʟ Lɪɴᴋ.\n\nCʜᴇᴄᴋ Oᴜᴛ Oᴜʀ Cʜᴀɴɴᴇʟꜱ Bᴇʟᴏᴡ Gᴏʀ Mᴏʀᴇ!👇</b>")
